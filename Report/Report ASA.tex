...
\item \textbf{Block}: This strategy consists of physically blocking the only delivery cells on the map to now allow enemies to score any more points, and thus should consist in an automatic win. This intention is triggered when the information stored in the beliefs sets satisfy three conditions:
\begin{itemize}
